...
for dts_one in tqdm(dts_all):
    ...
    # Create data loaders with batch_size from CONFIG
    train_loader, test_loader = model_data(
        stock_features_train, x_graph_train, true_returns, 
        stock_features_test, x_graph_test, 
    ...
    # Train and predict
    model_train_predict(
        num_models, num_epochs, save_path, dts_one[3], 
        kdcode_last, df3_2_dt, 
