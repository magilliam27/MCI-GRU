    ...
    try:
        ...
        for wi, cfg_w in enumerate(window_configs):
            ...
            train_loader, val_loader, test_loader = create_data_loaders(
                ...
                test_batch_size=cfg_w.training.test_batch_size,
                num_workers=cfg_w.training.dataloader_num_workers,
                pin_memory=cfg_w.training.dataloader_pin_memory,
                persistent_workers=cfg_w.training.dataloader_persistent_workers,
                prefetch_factor=cfg_w.training.dataloader_prefetch_factor,
