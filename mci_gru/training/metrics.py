...
def compute_metrics(
    ...
    if ic_values:
        ...
        metrics['ic_ir'] = float(np.mean(ic_values) / (np.std(ic_values) + 1e-8))  # Information Ratio
...
def compute_rank_metrics(
    ...
    metrics['long_short_spread'] = metrics[f'quantile_{quantiles}_return'] - metrics['quantile_1_return']
