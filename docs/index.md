...
| [agents/cockpit/workstream-decisions.json](agents/cockpit/workstream-decisions.json) | Versioned canonical decisions and reviewed git-surface dispositions for cockpit refreshes. |
