...
Test files: 78
Test functions: 449 (parametrized cases collapsed)
<!-- test-inventory-sha256: 8d9417db258b1f6cce81e9f5471f44b9028729e0b30b37b9d6520bd98767e464 -->
...
| Test | Description | Markers | Last run | Time (s) |
|---|---|---|---|---|
| `test_backtest_engine_golden` |  | parametrize | PASSED | 27.07 |
| `test_backtest_engine_deterministic` |  | parametrize | PASSED | 51.43 |
...
| Test | Description | Markers | Last run | Time (s) |
|---|---|---|---|---|
| `test_ensemble_prediction_is_mean_of_member_predictions` |  |  | PASSED | 0.16 |
...
| `test_shipped_simulators_all_accept_the_pit_universe` | Every dispatchable path admits on the PIT basis, so production never refuses. |  | PASSED | 0.76 |
...
| `test_internal_benchmark_uses_the_pit_filtered_universe` | Each booked benchmark return is the equal-weight mean over PIT-active rows only. | parametrize | PASSED | 0.84 |
| `test_pit_run_matches_a_universe_that_never_contained_the_name` | Public evaluate(): a PIT-restricted run equals a genuinely restricted universe. | parametrize | PASSED | 1.48 |
...
| `test_dispatch_matches_direct_simulator_call_without_pit` | With no PIT universe the unified dispatch reproduces the legacy call exactly. | parametrize | PASSED | 1.58 |
...
| `test_prepare_data_training_labels_never_consume_validation_closes` | End-to-end: no training label may read a close at or after val_start. | parametrize | PASSED | 0.71 |
...
| Test | Description | Markers | Last run | Time (s) |
|---|---|---|---|---|
| `test_compute_regime_monthly_features_outputs_expected_columns` |  |  | PASSED | 1.03 |
| `test_compute_regime_monthly_features_adds_subsequent_return_signals` |  |  | PASSED | 0.02 |
| `test_compute_regime_monthly_features_no_lookahead_exclusion_effect` |  |  | PASSED | 2.15 |
| `test_regime_subsequent_return_horizon_excludes_future_window` |  |  | PASSED | 0.88 |
| `test_add_regime_features_broadcasts_without_row_change` |  |  | PASSED | 2.94 |
...
| `test_retired_package_stays_out_of_packaging_and_imports` |  |  | PASSED | 0.86 |
...
| Test | Description | Markers | Last run | Time (s) |
|---|---|---|---|---|
| `test_positive_complete_60_date_fixture_can_claim_preliminary_but_not_confirmatory` |  |  | PASSED | 3.37 |
| `test_negative_60_date_fixture_reports_no_detectable_signal` |  |  | PASSED | 1.05 |
...
| Test | Description | Markers | Last run | Time (s) |
|---|---|---|---|---|
| `test_saved_prediction_selection_research_never_invokes_training` |  |  | PASSED | 2.23 |
...
| Test | Description | Markers | Last run | Time (s) |
|---|---|---|---|---|
| `test_issue8_ablation_notebook_defines_stage1_component_sweep` |  |  | PASSED | 0.02 |
