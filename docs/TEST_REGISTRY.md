...
Test files: 85
Test functions: 506 (parametrized cases collapsed)
<!-- test-inventory-sha256: e4829978d5a258c0eefe6ee48ec6c742d583424df04ba5e7c88a4775f017aef9 -->
...
| Test | Description | Markers | Last run | Time (s) |
|---|---|---|---|---|
| `test_backtest_engine_golden` |  | parametrize | PASSED | 35.04 |
| `test_backtest_engine_deterministic` |  | parametrize | PASSED | 70.04 |
...
| Test | Description | Markers | Last run | Time (s) |
|---|---|---|---|---|
| `test_plot_equity_curve_uses_agg_backend_when_saving` |  |  | PASSED | 0.67 |
...
| Test | Description | Markers | Last run | Time (s) |
|---|---|---|---|---|
| `test_dispatch_refuses_pit_universe_when_simulator_cannot_admit_it` | A simulator that cannot take the PIT universe must not be run with one. | parametrize | PASSED | 0.75 |
...
| `test_pit_run_matches_a_universe_that_never_contained_the_name` | Public evaluate(): a PIT-restricted run equals a genuinely restricted universe. | parametrize | PASSED | 1.86 |
...
| `test_compute_regime_monthly_features_no_lookahead_exclusion_effect` |  |  | PASSED | 3.08 |
| `test_regime_subsequent_return_horizon_excludes_future_window` |  |  | PASSED | 1.32 |
| `test_add_regime_features_broadcasts_without_row_change` |  |  | PASSED | 4.06 |
...
| `test_retired_package_stays_out_of_packaging_and_imports` |  |  | PASSED | 0.52 |
...
| `test_run_pytest_preserves_failure_exit_and_cleans_root` |  |  | PASSED | 0.71 |
...
| `test_run_pytest_contains_active_cache_and_removes_it` |  |  | PASSED | 0.67 |
...
| Test | Description | Markers | Last run | Time (s) |
|---|---|---|---|---|
| `test_positive_complete_60_date_fixture_can_claim_preliminary_but_not_confirmatory` |  |  | PASSED | 1.58 |
...
| Test | Description | Markers | Last run | Time (s) |
|---|---|---|---|---|
| `test_saved_prediction_selection_research_never_invokes_training` |  |  | PASSED | 2.89 |
...
| `test_the_floor_is_not_a_complete_directed_graph` | The counting form of the assertion above, stated against `n(n-1)`. |  | PASSED | 0.00 |
