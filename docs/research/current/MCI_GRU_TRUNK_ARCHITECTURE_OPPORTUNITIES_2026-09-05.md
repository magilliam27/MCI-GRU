...
`GRAPH_PAIRED_REANALYSIS_2026-09-02.md` (both read from their branch refs; they
are not yet on this worktree's base), the phase-2 and phase-3 trunk plans under
