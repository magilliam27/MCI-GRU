...
| --- | --- | --- | --- |
| `C:/Users/magil/MCI-GRU` dirty files | Active top-10 checkout | `AGENTS.md` adds the origin-main branch rule; untracked `docs/agents/agentic-engineering-process-plan.md`; untracked `MCI_GRU_PROGRAM_MAP_2026-06-19.md`; untracked `MCI_GRU_RESEARCH_OPPORTUNITY_SCAN_2026-06-19.md`; untracked `MCI_GRU_TOP_UNIVERSITY_RESEARCH_SCAN_2026-06-21.md`; untracked pytest review cost-rank-gate summary. | Preserve these on a branch, move them to a handoff/report branch, or discard the scratch output. |
