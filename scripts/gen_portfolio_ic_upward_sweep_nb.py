...
cells = [
    ...
    code(
        ...
        if "T4" in upper_gpu or not any(marker in upper_gpu for marker in allowed_markers):
            raise RuntimeError(f"Refusing GPU {gpu}; switch to a non-T4 G4-class or better runtime.")
