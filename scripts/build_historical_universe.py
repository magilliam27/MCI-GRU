...
def get_broad_universe() -> List[str]:
    ...
    additional_large_caps = [
        # Large tech/growth
        "GOOGL", "GOOG", "AMZN", "AAPL", "MSFT", "META", "NVDA", "TSLA",
        "NFLX", "ADBE", "CRM", "ORCL", "INTC", "AMD", "AVGO", "QCOM",
        # Finance
        "JPM", "BAC", "WFC", "C", "GS", "MS", "BLK", "SCHW", "AXP",
        # Healthcare
        "JNJ", "UNH", "PFE", "MRK", "ABBV", "TMO", "ABT", "LLY", "BMY",
        # Consumer
        "WMT", "PG", "KO", "PEP", "COST", "HD", "MCD", "NKE", "SBUX",
        # Industrial
        "BA", "CAT", "GE", "HON", "UPS", "UNP", "RTX", "LMT", "MMM",
        # Energy
...
def main():
    parser = argparse.ArgumentParser(
        description='Build historical stock universe by market cap'
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=500,
        help='Number of top stocks to select (default: 500)'
    )
    ...
    print("  " + "-" * 60)
    for i, row in top_stocks.head(20).iterrows():
