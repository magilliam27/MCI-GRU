...
def check_config():
    ...
    try:
        ...
        if 'hydra' in cfg:
            if 'run' in cfg.hydra and 'dir' in cfg.hydra.run:
                ...
                checks.append(f"  ✓ Hydra output directory configured")
            else:
    ...
    try:
        ...
        dates = [
            ...
            data_cfg.val_start, data_cfg.val_end,
            data_cfg.test_start, data_cfg.test_end
        ]
        ...
        if data_cfg.source == 'csv':
            ...
            if os.path.exists(data_cfg.filename):
                ...
                warnings.append(f"     Make sure to upload or generate this file before training")
    ...
    try:
        ...
        with open('evaluate_sp500.py', 'r', encoding='utf-8') as f:
            content = f.read()
